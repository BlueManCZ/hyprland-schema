...
# Hyprland version: v0.56.1
# Generated: 2026-07-28T05:36:06Z
# Source: https://github.com/hyprwm/Hyprland/blob/v0.56.1/src/config/values/ConfigValues.cpp

from hyprland_schema._model import HyprOption

HYPRLAND_VERSION = "v0.56.1"
...
OPTIONS: tuple[HyprOption, ...] = (
    ...
    HyprOption(
        ...
        section=("general",),
        name="layout",
        description="which layout to use. [dwindle/master/scrolling/monocle/lua:<name>]",
        type="string",
        default="dwindle",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("general",),
        name="allow_tearing",
        description="master switch for allowing tearing to occur.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("decoration", "shadow"),
        name="sharp",
        description="whether the shadow should be sharp or not.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="whether to enable further optimizations to the blur.",
        type="bool",
        default=True,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("decoration", "motion_blur"),
        name="enabled",
        description="enable motion blur for moving and resizing windows",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        section=("decoration", "motion_blur"),
        name="samples",
        description="amount of samples used for motion blur",
        type="int",
        default=7,
        min=1,
        max=64,
    ...
    HyprOption(
        ...
        description="Determines how keybinds act when multiple layouts are used.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("input",),
        name="accel_profile",
        description="Sets the cursor acceleration profile. [adaptive/flat/custom]",
        type="string",
        default="",
    ),
    HyprOption(
        ...
        section=("input",),
        name="force_no_accel",
        description="Force no cursor acceleration.",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="rotation",
        description=(
            "Sets the rotation of a device in degrees clockwise. Value is clamped to the rang"
            "e 0 to 359."
        ),
        type="int",
        default=0,
    ...
    HyprOption(
        ...
        section=("input",),
        name="scroll_points",
        description="Sets the scroll acceleration profile, when accel_profile is set to custom.",
        type="string",
        default="",
    ),
    HyprOption(
        ...
        section=("input",),
        name="scroll_method",
        description="Sets the scroll method. [2fg/edge/on_button_down/no_scroll]",
        type="string",
        default="",
    ),
    HyprOption(
        ...
        section=("input",),
        name="scroll_button",
        description="Sets the scroll button. 0 means default.",
        type="int",
        default=0,
        min=0,
        max=300,
    ...
    HyprOption(
        ...
        section=("input",),
        name="scroll_factor",
        description="Multiplier added to scroll movement for external mice.",
        type="float",
        default=1.0,
        min=0,
        max=2,
    ...
    HyprOption(
        ...
        section=("input",),
        name="natural_scroll",
        description="Inverts scrolling direction.",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        section=("input",),
        name="follow_mouse",
        description="Specify if and how cursor movement should affect window focus.",
        type="choice",
        default=1,
        enum_values=("disabled", "follow", "detached", "separate"),
        default_str="follow",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("input",),
        name="focus_on_close",
        description="Controls the window focus behavior when a window is closed.",
        type="choice",
        default=0,
        enum_values=("next", "cursor", "mru"),
        default_str="next",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="How to handle axis events around a focused window.",
        type="choice",
        default=1,
        enum_values=("ignore", "send", "clamp", "warp"),
        default_str="send",
    ),
    HyprOption(
        ...
        description="Emulates discrete scrolling from high resolution scrolling events.",
        type="choice",
        default=1,
        enum_values=("disable", "non_standard", "force_all"),
        default_str="non_standard",
    ),
    HyprOption(
        key="input:follow_mouse_shrink",
        section=("input",),
        name="follow_mouse_shrink",
        description=(
            "Shrinks the inactive window hitboxes used for focus detection by the specified n"
            "umber of pixels. This creates a dead zone in gaps between windows where moving t"
            "he cursor will not change focus. Works only with follow_mouse = 1."
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        description="Sending LMB and RMB simultaneously will be interpreted as a middle click.",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        section=("input", "touchpad"),
        name="tap_button_map",
        description="Sets the tap button mapping for touchpad button emulation. [lrm/lmr]",
        type="string",
        default="",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("input", "touchpad"),
        name="drag_3fg",
        description="Whether to use 3 or 4 finger drag.",
        type="choice",
        default=0,
        enum_values=("disable", "3_finger", "4_finger"),
        default_str="disable",
    ),
    HyprOption(
        ...
        name="transform",
        description="Transform the input from touchdevices.",
        type="int",
        default=0,
        min=0,
        max=6,
    ...
    HyprOption(
        ...
        section=("input", "touchdevice"),
        name="output",
        description="The monitor to bind touch devices.",
        type="string",
        default="",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        type="choice",
        default=2,
        enum_values=("disable", "enable", "only_non_ime"),
        default_str="only_non_ime",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        name="transform",
        description="transform the input from tablets.",
        type="int",
        default=0,
        min=0,
        max=6,
    ...
    HyprOption(
        ...
        section=("input", "tablet"),
        name="output",
        description="the monitor to bind tablets.",
        type="string",
        default="",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("input", "tablet"),
        name="region_size",
        description="size of the mapped region.",
        type="vec2",
        default=(0.0, 0.0),
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("input", "tablettool"),
        name="eraser_button_mode",
        description=(
            "Change the eraser button behavior on the tool. When set to 0, use the default ha"
            "rdware behavior of the tool. When set to 1, the eraser button on the tool sends "
            "a button event instead."
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        section=("input", "tablettool"),
        name="eraser_button_override",
        description=(
            "Set a button to be button event when eraser_button_mode is set to 1. Has to be a"
            "n int, cannot be a string. Must be a valid button (e.g. BTN_STYLUS) excluding fa"
            "ke buttons (e.g. BTN_TOOL_*) and keys (KEY_*). Check wev if you have any doubts "
            "regarding the ID. 0 means default."
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        section=("input", "tablettool"),
        name="pressure_range_min",
        description=(
            "Set the minimum pressure range for the tool, a negative number will set the defa"
            "ult minimum pressure value. This is usually 0.0"
        ),
        type="float",
        default=-1.0,
        min=-1.0,
    ...
    HyprOption(
        ...
        section=("input", "tablettool"),
        name="pressure_range_max",
        description=(
            "Set the maximum pressure range for the tool, a negative number will set the defa"
            "ult maximum pressure value. This is usually 1.0"
        ),
        type="float",
        default=-1.0,
        min=-1.0,
    ...
    HyprOption(
        ...
        description="minimum speed in px per timepoint to force the change ignoring cancel_ratio.",
        type="int",
        default=30,
        min=0,
        max=200,
    ...
    HyprOption(
        ...
        description="how much the swipe has to proceed in order to commence it.",
        type="float",
        default=0.5,
        min=0,
        max=1,
    ...
    HyprOption(
        key="gestures:scrolling:move_snap_to_grid",
        section=("gestures", "scrolling"),
        name="move_snap_to_grid",
        description=(
    ...
    HyprOption(
        key="gestures:scrolling:move_snap_cursor",
        section=("gestures", "scrolling"),
        name="move_snap_cursor",
        description=(
            "When releasing the scroll move gesture, whether it shoud snap the cursor to the "
    ...
    HyprOption(
        ...
        description="inactive group border color",
        type="gradient",
        default="0x66777700",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="whether dragging a window into a unlocked group will merge them.",
        type="choice",
        default=1,
    ...
    HyprOption(
        ...
        description="color for inactive windows' titles in the groupbar",
        type="color",
        default=-1,
    ),
    HyprOption(
        ...
        description="color for the active window's title in a locked group",
        type="color",
        default=-1,
    ),
    HyprOption(
        ...
        description="color for inactive windows' titles in locked groups",
        type="color",
        default=-1,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="disables the Hyprland splash rendering.",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        section=("misc",),
        name="col.splash",
        description="Changes the color of the splash text.",
        type="color",
        default="0x55ffffff",
    ),
    HyprOption(
        ...
        section=("misc",),
        name="font_family",
        description="Set the global default font to render the text.",
        type="string",
        default="Sans",
    ),
    HyprOption(
        ...
        description="Changes the font used to render the splash text.",
        type="string",
        default="",
    ),
    HyprOption(
        ...
        description="Force any of the 3 default wallpapers. [-1/0/1/2]",
        type="int",
        default=-1,
        min=-1,
        max=2,
    ...
    HyprOption(
        ...
        section=("misc",),
        name="vrr",
        description="controls the VRR (Adaptive Sync) of your monitors",
        type="choice",
        default=0,
        enum_values=("off", "on", "fullscreen", "fullscreen_game"),
        default_str="off",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="Name virtual keyboards after the processes that create them.",
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        description="Will make mouse focus follow the mouse when drag and dropping.",
        type="bool",
        default=True,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="If true, will animate windows being dragged by mouse.",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description="If true, the config will not reload automatically on save.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("misc",),
        name="swallow_regex",
        description="The class regex to be used for windows that should be swallowed.",
        type="string",
        default="",
    ),
    HyprOption(
        ...
        description="The title regex to be used for windows that should not be swallowed.",
        type="string",
        default="",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("misc",),
        name="session_lock_blur",
        description="Enable blur for lockscreen. You probably want to enable `session_lock_xray`.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description=(
            ...
            "ested to focus should replace it."
        ),
        type="choice",
        default=2,
        enum_values=("ignore", "take_over", "exit_fullscreen"),
        default_str="exit_fullscreen",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="if enabled, windows will open on the workspace they were invoked on.",
        type="int",
        default=1,
        min=0,
        max=2,
    ...
    HyprOption(
        ...
        section=("misc",),
        name="initial_workspace_token_timeout",
        description=(
            "the time in seconds a window has to open on its invoked workspace before the tra"
            "cking token expires."
        ),
        type="int",
        default=10,
    ...
    HyprOption(
        ...
        description="the delay in ms after the lockdead screen appears.",
        type="int",
        default=1000,
        min=0,
        max=5000,
    ...
    HyprOption(
        ...
        description="forces 8 bit screencopy",
        type="bool",
        default=True,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description=(
            "If enabled, changing the active workspace will hide the special workspace on the"
            " monitor."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description="If enabled, workspaces don't forget their previous workspace.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="If enabled, when on a fullscreen window, movefocus will cycle fullscreen.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description=(
            ...
            " will move it to the next monitor."
        ),
        type="bool",
        default=True,
    ),
    ...
    HyprOption(
        ...
        section=("render",),
        name="direct_scanout",
        description="Enables direct scanout.",
        type="choice",
        default=0,
        enum_values=("disable", "enable", "auto"),
        default_str="disable",
    ),
    HyprOption(
        ...
        description="Whether to expand textures that have not yet resized to be larger.",
        type="bool",
        default=True,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("render",),
        name="ctm_animation",
        description="Whether to enable a fade animation for CTM changes.",
        type="choice",
        default=2,
        enum_values=("disable", "enable", "auto"),
        default_str="auto",
    ...
    HyprOption(
        ...
        description="Report content type to allow monitor profile autoswitch",
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        section=("render",),
        name="cm_auto_hdr",
        description="Auto-switch to hdr mode when fullscreen app is in hdr",
        type="choice",
        default=1,
        enum_values=("disable", "hdr", "hdredid"),
        default_str="hdr",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("render",),
        name="non_shader_cm",
        description="Enable CM without shader.",
        type="choice",
        default=3,
    ...
    HyprOption(
        ...
        section=("render",),
        name="cm_sdr_eotf",
        description="Default transfer function for displaying SDR apps.",
        type="string",
        default="default",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("render",),
        name="keep_unmodified_copy",
        description="Keep umodified SDR frame copy for sreensharing.",
        type="choice",
        default=2,
        enum_values=("disable", "enable", "auto"),
        default_str="auto",
    ...
    HyprOption(
        ...
        section=("render",),
        name="non_shader_cm_interop",
        description="non_shader_cm interaction with ctm proto (hyprsunset and similar).",
        type="choice",
        default=2,
        enum_values=("disable", "enable", "auto"),
        default_str="auto",
    ...
    HyprOption(
        ...
        section=("render",),
        name="fp16_sdr_tf",
        description="Internal workbuffer transfer function for fp16 in SDR mode",
        type="choice",
        default=0,
        enum_values=("monitor", "linear"),
        default_str="monitor",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="minimum refresh rate for cursor movement when no_break_fs_vrr is active.",
        type="int",
        default=24,
        min=10,
        max=500,
    ...
    HyprOption(
        ...
        section=("cursor",),
        name="no_warps",
        description="if true, will not warp the cursor in many cases",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="Move the cursor to the last focused window after changing the workspace.",
        type="choice",
        default=0,
        enum_values=("disable", "enable", "force"),
        default_str="disable",
    ),
    HyprOption(
        ...
        description="Move the cursor to the last focused window when toggling a special workspace.",
        type="choice",
        default=0,
        enum_values=("disable", "enable", "force"),
        default_str="disable",
    ...
    HyprOption(
        ...
        description="the name of a default monitor for the cursor to be set to on startup",
        type="string",
        default="",
    ),
    HyprOption(
        ...
        section=("cursor",),
        name="zoom_factor",
        description="the factor to zoom by around the cursor. 1 means no zoom.",
        type="float",
        default=1.0,
        min=1,
        max=10,
    ...
    HyprOption(
        ...
        section=("cursor",),
        name="zoom_rigid",
        description="whether the zoom should follow the cursor rigidly or loosely",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description="If enabled, when zooming, no antialiasing will be used",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description="Detaches the camera from the mouse when zoomed in",
        type="bool",
        default=True,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("cursor",),
        name="use_cpu_buffer",
        description="Makes HW cursors use a CPU buffer.",
        type="choice",
        default=2,
        enum_values=("disable", "enable", "auto"),
        default_str="auto",
    ...
    HyprOption(
        ...
        description="sync xcursor theme with gsettings",
        type="bool",
        default=True,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("debug",),
        name="damage_blink",
        description="flash damaged areas",
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        section=("debug",),
        name="gl_debugging",
        description="enable OpenGL debugging and error checking.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="redraw only the needed bits of the display.",
        type="choice",
        default=2,
        enum_values=("disable", "monitor", "full"),
        default_str="full",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="disables verification of the scale factors.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        section=("debug",),
        name="error_position",
        description="sets the position of the error bar.",
        type="choice",
        default=0,
    ...
    HyprOption(
        key="debug:invalidate_fp16",
        section=("debug",),
        name="invalidate_fp16",
    ...
    HyprOption(
        ...
        description="Minimum distance for single_window_aspect_ratio to take effect.",
        type="float",
        default=0.1,
        min=0.0,
        max=1.0,
    ...
    HyprOption(
        ...
        section=("dwindle",),
        name="force_split",
        description="force a split direction for new windows",
        type="choice",
        default=0,
        enum_values=("follow_mouse", "left", "right"),
        default_str="follow_mouse",
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="if enabled, makes the preselect direction persist.",
        type="bool",
        default=False,
    ),
    HyprOption(
    ...
    HyprOption(
        ...
        description="the default split ratio on window open.",
        type="float",
        default=1.0,
        min=0.1,
        max=1.9,
    ...
    HyprOption(
        ...
        section=("dwindle",),
        name="split_bias",
        description="specifies which window will receive the split ratio.",
        type="choice",
        default=0,
    ...
    HyprOption(
        ...
        section=("master",),
        name="mfact",
        description="the size as a percentage of the master window.",
        type="float",
        default=0.55,
        min=0,
        max=1,
    ...
    HyprOption(
        ...
        description=(
            ...
            "e new window according to new_on_top."
        ),
        type="string",
        default="none",
    ),
    ...
    HyprOption(
        ...
        description=(
            ...
            "t this many slave windows are open."
        ),
        type="int",
        default=2,
        min=0,
    ...
    HyprOption(
        key="scrolling:wrap_focus",
        section=("scrolling",),
        name="wrap_focus",
        description="Determines if column focus wraps around",
        type="bool",
        default=True,
    ),
    HyprOption(
        key="scrolling:wrap_swapcol",
        section=("scrolling",),
        name="wrap_swapcol",
        description="Determines if column movement wraps around",
        type="bool",
        default=True,
    ),
    HyprOption(
        key="experimental:wp_cm_1_2",
    ...
    HyprOption(
        key="input-capture:capture_modifiers",
        section=("input-capture",),
        name="capture_modifiers",
        description="If enabled, modifiers are also captured and sent to the program",
        type="bool",
        default=False,
    ),
    HyprOption(
        key="input-capture:enforce_barriers",
        section=("input-capture",),
        name="enforce_barriers",
    ...
    HyprOption(
        ...
        section=("quirks",),
        name="prefer_hdr",
        description="Prefer HDR mode.",
        type="choice",
        default=0,
        enum_values=("disable", "enable", "gamescope_only"),
        default_str="disable",
    ),
    HyprOption(
