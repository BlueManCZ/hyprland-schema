...
# Hyprland version: v0.54.2
# Generated: 2026-03-21T12:23:16Z
# Source: https://github.com/hyprwm/Hyprland/blob/v0.54.2/src/config/ConfigDescriptions.hpp
...
OPTIONS: tuple[HyprOption, ...] = (
    ...
    HyprOption(
        ...
        name="gaps_in",
        description=(
            "gaps between windows\n\nsupports css style gaps (top, right, bottom, left -> 5 10 15 2"
            "0)"
        ),
        type="string",
        default="5",
    ...
    HyprOption(
        ...
        name="gaps_out",
        description=(
            "gaps between windows and monitor edges\n\nsupports css style gaps (top, right, bottom,"
            " left -> 5 10 15 20)"
        ),
        type="string",
        default="20",
    ...
    HyprOption(
        ...
        description=(
            "inactive border color for window that cannot be added to a group (see denywindowfromgr"
            "oup dispatcher)"
        ),
        type="gradient",
        default="0xffffaaff",
    ...
    HyprOption(
        ...
        description=(
            "if true, will not fall back to the next available window when moving focus in a direct"
            "ion where no window was found"
        ),
        type="bool",
        default=False,
    ),
    ...
    HyprOption(
        ...
        description=(
            "extends the area around the border where you can click and drag on, only used when gen"
            "eral:resize_on_border is on."
        ),
        type="int",
        default=15,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "show a cursor icon when hovering over borders, only used when general:resize_on_border"
            " is on."
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        name="resize_corner",
        description=(
            "force floating windows to use a specific corner when being resized (1-4 going clockwis"
            "e from top left, 0 to disable)"
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        name="screen_shader",
        description=(
            "screen_shader a path to a custom shader to be applied at the end of rendering. See exa"
            "mples/screenShader.frag for an example."
        ),
        type="string",
        default="",
    ),
    ...
    HyprOption(
        ...
        description=(
            "whether to enable further optimizations to the blur. Recommended to leave on, as it wi"
            "ll massively improve performance."
        ),
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        name="xray",
        description=(
            "if enabled, floating windows will ignore tiled windows in their blur. Only available i"
            "f blur_new_optimizations is true. Will reduce overhead on floating blur significantly."
        ),
        type="bool",
        default=False,
    ),
    ...
    HyprOption(
        ...
        description=(
            "works like ignorealpha in layer rules. If pixel opacity is below set value, will not b"
            "lur. [0.0 - 1.0]"
        ),
        type="float",
        default=0.2,
    ...
    HyprOption(
        ...
        description=(
            "Determines how keybinds act when multiple layouts are used. If false, keybinds will al"
            "ways act as if the first specified layout is active. If true, keybinds specified by sy"
            "mbols are activated when you type the respective symbol with the current layout."
        ),
        type="bool",
        default=False,
    ),
    ...
    HyprOption(
        ...
        name="accel_profile",
        description=(
            "Sets the cursor acceleration profile. Can be one of adaptive, flat. Can also be custom"
            ", see below. Leave empty to use libinput's default mode for your input device. [adapti"
            "ve/flat/custom]"
        ),
        type="string",
        default="",
    ...
    HyprOption(
        ...
        name="force_no_accel",
        description=(
            "Force no cursor acceleration. This bypasses most of your pointer settings to get as ra"
            "w of a signal as possible. Enabling this is not recommended due to potential cursor de"
            "synchronization."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        name="rotation",
        description=(
            "Sets the rotation of a device in degrees clockwise off the logical neutral position. V"
            "alue is clamped to the range 0 to 359."
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        name="scroll_points",
        description=(
            "Sets the scroll acceleration profile, when accel_profile is set to custom. Has to be i"
            "n the form <step> <points>. Leave empty to have a flat scroll curve."
        ),
        type="string",
        default="",
    ),
    ...
    HyprOption(
        ...
        name="scroll_button",
        description=(
            "Sets the scroll button. Has to be an int, cannot be a string. Check wev if you have an"
            "y doubts regarding the ID. 0 means default."
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "If the scroll button lock is enabled, the button does not need to be held down. Pressi"
            "ng and releasing the button toggles the button lock, which logically holds the button "
            "down or releases it. While the button is logically held down, motion events are conver"
            "ted to scroll events."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="scroll_factor",
        description=(
            "Multiplier added to scroll movement for external mice. Note that there is a separate s"
            "etting for touchpad scroll_factor."
        ),
        type="float",
        default=1.0,
        min=0.0,
    ...
    HyprOption(
        ...
        name="natural_scroll",
        description=(
            "Inverts scrolling direction. When enabled, scrolling moves content directly, rather th"
            "an manipulating a scrollbar."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="follow_mouse",
        description=(
            "Specify if and how cursor movement should affect window focus. See the note below. [0/"
            "1/2/3]"
        ),
        type="int",
        default=1,
    ...
    HyprOption(
        ...
        description=(
            "The smallest distance in logical pixels the mouse needs to travel for the window under"
            " it to get focused. Works only with follow_mouse = 1."
        ),
        type="float",
        default=0.0,
        min=0.0,
    ...
    HyprOption(
        ...
        name="focus_on_close",
        description=(
            "Controls the window focus behavior when a window is closed. When set to 0, focus will "
            "shift to the next window candidate. When set to 1, focus will shift to the window unde"
            "r the cursor."
        ),
        type="choice",
        default=0,
    ...
    HyprOption(
        ...
        name="mouse_refocus",
        description=(
            "if disabled, mouse focus won't switch to the hovered window unless the mouse crosses a"
    ...
    HyprOption(
        ...
        description=(
            "If enabled (1 or 2), focus will change to the window under the cursor when changing fr"
            "om tiled-to-floating and vice versa. If 2, focus will also follow mouse on float-to-fl"
            "oat switches."
        ),
        type="int",
        default=1,
    ...
    HyprOption(
        ...
        description=(
            ...
            "ing windows in the regular workspace."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description=(
            "Handles axis events around (gaps/border for tiled, dragarea/border for floated) a focu"
            "sed window. 0 ignores axis events 1 sends out-of-bound coordinates 2 fakes pointer coo"
            "rdinates to the closest point inside the window 3 warps the cursor to the closest poin"
            "t inside the window"
        ),
        type="int",
        default=1,
    ...
    HyprOption(
        ...
        description=(
            "Emulates discrete scrolling from high resolution scrolling events. 0 disables it, 1 en"
            "ables handling of non-standard events only, and 2 force enables all scroll wheel event"
            "s to be handled"
        ),
        type="int",
        default=1,
    ...
    HyprOption(
        ...
        description=(
            "Sending LMB and RMB simultaneously will be interpreted as a middle click. This disable"
            "s any touchpad area that would normally send a middle click based on location."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="tap_button_map",
        description=(
            "Sets the tap button mapping for touchpad button emulation. Can be one of lrm (default)"
            " or lmr (Left, Middle, Right Buttons). [lrm/lmr]"
        ),
        type="string",
        default="",
    ),
    HyprOption(
        ...
        description=(
            "Button presses with 1, 2, or 3 fingers will be mapped to LMB, RMB, and MMB respectivel"
            "y. This disables interpretation of clicks based on location on the touchpad."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="tap-to-click",
        description=(
            "Tapping on the touchpad with 1, 2, or 3 fingers will send LMB, RMB, and MMB respective"
            "ly."
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        name="drag_lock",
        description=(
            "When enabled, lifting the finger off while dragging will not drop the dragged item. 0 "
            "-> disabled, 1 -> enabled with timeout, 2 -> enabled sticky.dragging will not drop the"
            " dragged item."
        ),
        type="int",
        default=0,
    ...
    HyprOption(
        ...
        name="transform",
        description=(
            "Transform the input from touchdevices. The possible transformations are the same as th"
            "ose of the monitors"
        ),
        type="int",
        default=0,
    ...
    HyprOption(
        ...
        name="output",
        description=(
            "The monitor to bind touch devices. The default is auto-detection. To stop auto-detecti"
            "on, use an empty string or the [[Empty]] value."
        ),
        type="string",
        default="",
    ),
    ...
    HyprOption(
        ...
        name="share_states",
        description=(
            "Unify key down states and modifier states with other keyboards. 0 -> no, 1 -> yes, 2 -"
            "> yes unless IME client"
        ),
        type="int",
        default=2,
        min=0,
    ...
    HyprOption(
        ...
        name="transform",
        description=(
            "transform the input from tablets. The possible transformations are the same as those o"
            "f the monitors"
        ),
        type="int",
        default=0,
    ...
    HyprOption(
        ...
        name="output",
        description=(
            "the monitor to bind tablets. Can be current or a monitor name. Leave empty to map acro"
            "ss all monitors."
        ),
        type="string",
        default="",
    ...
    HyprOption(
        ...
        description=(
            "position of the mapped region in monitor layout relative to the top left corner of the"
            " bound monitor or all monitors."
        ),
        type="vec2",
        default=(0.0, 0.0),
    ...
    HyprOption(
        ...
        description=(
            "whether to treat the region_position as an absolute position in monitor layout. Only a"
            "pplies when output is empty."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="region_size",
        description=(
            "size of the mapped region. When this variable is set, tablet input will be mapped to t"
            "he region. [0, 0] or invalid size means unset."
        ),
        type="vec2",
        default=(0.0, 0.0),
    ...
    HyprOption(
        ...
        description=(
            "minimum speed in px per timepoint to force the change ignoring cancel_ratio. Setting t"
            "o 0 will disable this mechanic."
        ),
        type="int",
        default=30,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "how much the swipe has to proceed in order to commence it. (0.7 -> if > 0.7 * distance"
            ", switch, if less, revert) [0.0 - 1.0]"
        ),
        type="float",
        default=0.5,
        min=0.0,
    ...
    HyprOption(
        ...
        description=(
            "if enabled, switching direction will be locked when you swipe past the direction_lock_"
            "threshold (touchpad only)."
        ),
        type="bool",
        default=True,
    ),
    ...
    HyprOption(
        ...
        description=(
            "if enabled, swiping will not clamp at the neighboring workspaces but continue to the f"
            "urther ones."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "if enabled, swiping will use the r prefix instead of the m prefix for finding workspac"
            "es."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "whether dragging a window into a unlocked group will merge them. Options: 0 (disabled)"
            ", 1 (enabled), 2 (only when dragging into the groupbar)"
        ),
        type="choice",
        default=0,
    ...
    HyprOption(
        ...
        description=(
            "whether using movetoworkspace[silent] will merge the window into the workspace's solit"
            "ary unlocked group"
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "color for the active window's title in a locked group (if unset, defaults to text_colo"
            "r)"
        ),
        type="color",
        default=None,
    ...
    HyprOption(
        ...
        description=(
            "color for inactive windows' titles in locked groups (if unset, defaults to text_color_"
            "inactive)"
        ),
        type="color",
        default=None,
    ...
    HyprOption(
        ...
        name="font_family",
        description=(
            "Set the global default font to render the text including debug fps/notification, confi"
            "g error messages and etc., selected from system fonts."
        ),
        type="string",
        default="Sans",
    ),
    HyprOption(
        ...
        description=(
            "Changes the font used to render the splash text, selected from system fonts (requires "
            "a monitor reload to take effect)."
        ),
        type="string",
        default="",
    ),
    HyprOption(
        ...
        description=(
            "Enforce any of the 3 default wallpapers. Setting this to 0 or 1 disables the anime bac"
            "kground. -1 means “random”. [-1/0/1/2]"
        ),
        type="int",
        default=-1,
        min=-1,
    ...
    HyprOption(
        ...
        name="vfr",
        description=(
            "controls the VFR status of Hyprland. Heavily recommended to leave enabled to conserve "
            "resources."
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        name="vrr",
        description=(
            "controls the VRR (Adaptive Sync) of your monitors. 0 - off, 1 - on, 2 - fullscreen onl"
            "y, 3 - fullscreen with game or video content type [0/1/2/3]"
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "Name virtual keyboards after the processes that create them. E.g. /usr/bin/fcitx5 will"
            " have hl-virtual-keyboard-fcitx5."
        ),
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        description=(
            "Will make mouse focus follow the mouse when drag and dropping. Recommended to leave it"
            " enabled, especially for people using focus follows mouse at 0."
        ),
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        description=(
            "If true, will make keyboard-interactive layers keep their focus on mouse move (e.g. wo"
            "fi, bemenu)"
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        description=(
            "If true, will animate windows being dragged by mouse, note that this can cause weird b"
            "ehavior on some curves"
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description=(
            "If true, the config will not reload automatically on save, and instead needs to be rel"
            "oaded with hyprctl reload. Might save on battery."
        ),
        type="bool",
        default=False,
    ),
    ...
    HyprOption(
        ...
        description=(
            "The title regex to be used for windows that should not be swallowed by the windows spe"
            "cified in swallow_regex (e.g. wev). The regex is matched against the parent (e.g. Kitt"
            "y) window’s title on the assumption that it changes to whatever process it’s running."
        ),
        type="string",
        default="",
    ),
    ...
    HyprOption(
        ...
        description=(
            "if true, will allow you to restart a lockscreen app in case it crashes (red screen of "
            "death)"
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "if there is a fullscreen or maximized window, decide whether a tiled window requested "
            "to focus should replace it, stay behind or disable the fullscreen/maximized state. 0 -"
            " ignore focus request (keep focus on fullscreen window), 1 - takes over, 2 - unfullscr"
            "een/unmaximize [0/1/2]"
        ),
        type="int",
        default=2,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "if enabled, windows will open on the workspace they were invoked on. 0 - disabled, 1 -"
            " single-shot, 2 - persistent (all children too)"
        ),
        type="int",
        default=1,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "the delay in ms after the lockdead screen appears if the lock screen did not appear af"
            "ter a lock event occurred."
        ),
        type="int",
        default=1000,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "disables notification popup when a monitor fails to set a suitable scale and falls bac"
            "k to suggested"
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "if disabled, will not pass the mouse events to apps / dragging windows around if a key"
            "bind has been triggered."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description=(
            "in ms, how many ms to wait after a scroll event to allow passing another one for the b"
            "inds."
        ),
        type="int",
        default=300,
    ...
    HyprOption(
        ...
        description=(
            "If enabled, an attempt to switch to the currently focused workspace will instead switc"
            "h to the previous workspace. Akin to i3’s auto_back_and_forth."
        ),
        type="bool",
        default=False,
    ),
    ...
    HyprOption(
        ...
        description=(
            ...
            " by switching to the first workspace in a sequence, then endlessly going to the previo"
            "us workspace."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "Whether switching workspaces should center the cursor on the workspace (0) or on the l"
            "ast active window for that workspace (1)"
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "sets the preferred focus finding method when using focuswindow/movewindow/etc with a d"
            "irection. 0 - history (recent have priority), 1 - length (longer shared edges have pri"
            "ority)"
        ),
        type="int",
        default=0,
    ...
    HyprOption(
        ...
        description=(
            "If enabled, dispatchers like moveintogroup, moveoutofgroup and movewindoworgroup will "
            "ignore lock per group."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description=(
            "If enabled, when on a fullscreen window, movefocus will cycle fullscreen, if not, it w"
            "ill move the focus in a direction."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description=(
            ...
            ", then at each ends of tabs, it'll move on to other windows/groups"
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description=(
            "If enabled, apps that request keybinds to be disabled (e.g. VMs) will not be able to d"
            "o so."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "uses the nearest neighbor filtering for xwayland apps, making them pixelated rather th"
            "an blurry"
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        description=(
            "reduces flickering on nvidia at the cost of possible frame drops on lower-end GPUs. On"
            " non-nvidia, this is ignored."
        ),
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        name="direct_scanout",
        description=(
            "Enables direct scanout. Direct scanout attempts to reduce lag when there is only one f"
            "ullscreen application on a screen (e.g. game). It is also recommended to set this to f"
            "alse if the fullscreen application shows graphical glitches. 0 - off, 1 - on, 2 - auto"
            " (on with content type 'game')"
        ),
        type="int",
        default=0,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "Whether to expand textures that have not yet resized to be larger, or to just stretch "
            "them instead."
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        name="ctm_animation",
        description=(
            "Whether to enable a fade animation for CTM changes (hyprsunset). 2 means 'auto' (Yes o"
            "n everything but Nvidia)."
        ),
        type="int",
        default=2,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "Report content type to allow monitor profile autoswitch (may result in a black screen "
            "during the switch)"
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        description=(
            "enable new render scheduling, which should improve FPS on underpowered devices. This d"
            "oes not add latency when your PC can keep up."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="non_shader_cm",
        description=(
            "Enable CM without shader. 0 - disable, 1 - whenever possible, 2 - DS and passthrough o"
            "nly, 3 - disable and ignore CM issues"
        ),
        type="choice",
        default=0,
    ...
    HyprOption(
        ...
        name="cm_sdr_eotf",
        description=(
            "Default transfer function for displaying SDR apps. default - Use default value (Gamma "
            "2.2), gamma22 - Treat unspecified as Gamma 2.2, gamma22force - Treat unspecified and s"
            "RGB as Gamma 2.2, srgb - Treat unspecified as sRGB"
        ),
        type="string",
        default="default",
    ),
    ...
    HyprOption(
        ...
        description=(
            ...
            " to avoid framerate spikes (may require no_hardware_cursors = true) 0 - off, 1 - on, 2"
    ...
    HyprOption(
        ...
        description=(
            "minimum refresh rate for cursor movement when no_break_fs_vrr is active. Set to minimu"
            "m supported refresh rate or higher"
        ),
        type="int",
        default=24,
        min=10,
    ...
    HyprOption(
        ...
        description=(
            "in seconds, after how many seconds of cursor’s inactivity to hide it. Set to 0 for nev"
            "er."
        ),
        type="int",
        default=0,
    ...
    HyprOption(
        ...
        description=(
            "When a window is refocused, the cursor returns to its last position relative to that w"
            "indow, rather than to the centre."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        description=(
            "Move the cursor to the last focused window after changing the workspace. Options: 0 (D"
            "isabled), 1 (Enabled), 2 (Force - ignores cursor:no_warps option)"
        ),
        type="choice",
        default=0,
    ...
    HyprOption(
        ...
        description=(
            "Move the cursor to the last focused window when toggling a special workspace. Options:"
    ...
    HyprOption(
        ...
        description=(
            "the name of a default monitor for the cursor to be set to on startup (see hyprctl moni"
            "tors for names)"
        ),
        type="string",
        default="",
    ...
    HyprOption(
        ...
        name="zoom_factor",
        description=(
            "the factor to zoom by around the cursor. Like a magnifying glass. Minimum 1.0 (meaning"
            " no zoom)"
        ),
        type="float",
        default=1.0,
    ...
    HyprOption(
        ...
        name="zoom_rigid",
        description=(
            "whether the zoom should follow the cursor rigidly (cursor is always centered if it can"
            " be) or loosely"
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "Detaches the camera from the mouse when zoomed in, only ever moving to keep the mouse "
            "in view"
        ),
        type="bool",
        default=True,
    ...
    HyprOption(
        ...
        name="use_cpu_buffer",
        description=(
            "Makes HW cursors use a CPU buffer. Required on Nvidia to have HW cursors. 0 - off, 1 -"
            " on, 2 - auto (nvidia only)"
        ),
        type="int",
        default=2,
        min=0,
    ...
    HyprOption(
        ...
        description=(
            "sync xcursor theme with gsettings, it applies cursor-theme and cursor-size on theme lo"
            "ad to gsettings making most CSD gtk based clients use same xcursor theme and size."
        ),
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        description=(
            "warp the cursor back to where it was after using a non-mouse input to move it, and the"
            "n returning back to mouse."
        ),
        type="bool",
        default=False,
    ),
    ...
    HyprOption(
        ...
        description=(
            "whether to enable permission control (see https://wiki.hypr.land/Configuring/Permissio"
            "ns/)."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "redraw only the needed bits of the display. Do not change. (default: full - 2) monitor"
            " - 1, none - 0"
        ),
        type="int",
        default=2,
    ...
    HyprOption(
        ...
        description=(
            "disables verification of the scale factors. Will result in pixel alignment and roundin"
            "g errors."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "If specified, whenever only a single window is open, it will be coerced into the speci"
            "fied aspect ratio.  Ignored if the y-value is zero."
        ),
        type="vec2",
        default=(0.0, 0.0),
        default_min=(0.0, 0.0),
    ...
    HyprOption(
        ...
        description=(
            "Minimum distance for single_window_aspect_ratio to take effect, in fractions of the mo"
            "nitor's size."
        ),
        type="float",
        default=0.1,
    ...
    HyprOption(
        ...
        name="force_split",
        description=(
            "0 -> split follows mouse, 1 -> always split to the left (new = left or top) 2 -> alway"
            "s split to the right (new = right or bottom)"
        ),
        type="choice",
        default=0,
    ...
    HyprOption(
        ...
        name="preserve_split",
        description=(
            "if enabled, the split (side/top) will not change regardless of what happens to the con"
            "tainer."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        name="smart_split",
        description=(
            "if enabled, allows a more precise control over the window split direction based on the"
            " cursor's position. The window is conceptually divided into four triangles, and cursor"
            "'s triangle determines the split direction. This feature also turns on preserve_split."
        ),
        type="bool",
        default=False,
    ),
    HyprOption(
        ...
        name="smart_resizing",
        description=(
            "if enabled, resizing direction will be determined by the mouse's position on the windo"
            "w (nearest to which corner). Else, it is based on the window's tiling position."
        ),
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        description=(
            ...
            ", another direction is specified, or a non-direction is specified (anything other than"
            " l,r,u/t,d/b)"
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        name="split_bias",
        description=(
            "specifies which window will receive the split ratio. 0 -> directional (the top or left"
            " window), 1 -> the current window"
        ),
        type="choice",
        default=0,
    ...
    HyprOption(
        ...
        description=(
            "if enabled, bindm movewindow will drop the window more precisely depending on where yo"
            "ur mouse is."
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        name="mfact",
        description=(
            "the size as a percentage of the master window, for example `mfact = 0.70` would mean 7"
            "0% of the screen will be the master window, and 30% the slave [0.0 - 1.0]"
        ),
        type="float",
        default=0.55,
        min=0.0,
    ...
    HyprOption(
        ...
        name="new_status",
        description=(
            "`master`: new window becomes master; `slave`: new windows are added to slave stack; `i"
            "nherit`: inherit from focused window"
        ),
        type="string",
        default="slave",
    ),
    ...
    HyprOption(
        ...
        name="new_on_active",
        description=(
            "`before`, `after`: place new window relative to the focused window; `none`: place new "
            "window according to the value of `new_on_top`."
        ),
        type="string",
        default="none",
    ),
    ...
    HyprOption(
        ...
        description=(
            "when using orientation=center, make the master window centered only when at least this"
            " many slave windows are open. (Set 0 to always_center_master)"
        ),
        type="int",
        default=2,
        min=0,
    ...
    HyprOption(
        ...
        name="drop_at_cursor",
        description=(
            "when enabled, dragging and dropping windows will put them at the cursor position. Othe"
            "rwise, when dropped at the stack side, they will go to the top/bottom of the stack dep"
            "ending on new_on_top."
        ),
        type="bool",
        default=True,
    ),
    HyprOption(
        ...
        description=(
            "whether to keep the master window in its configured position when there are no slave w"
            "indows"
        ),
        type="bool",
        default=False,
    ...
    HyprOption(
        ...
        description=(
            "when a window is focused, require that at least a given fraction of it is visible for "
            "focus to follow"
        ),
        type="float",
        default=0.4,
